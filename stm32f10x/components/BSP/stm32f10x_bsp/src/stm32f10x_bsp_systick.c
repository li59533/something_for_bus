...
/**
 * @addtogroup    stm32f10x_bsp_systick_Modules 
 * @{  
 */
#if BSP_SYSTICK_MODULE_ENABLE == 1
/**
 * @defgroup      stm32f10x_bsp_systick_IO_Defines 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup       stm32f10x_bsp_systick_Macros_Defines 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32f10x_bsp_systick_Constants_Defines 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup       stm32f10x_bsp_systick_Private_Types
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32f10x_bsp_systick_Private_Variables 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32f10x_bsp_systick_Public_Variables 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32f10x_bsp_systick_Private_FunctionPrototypes 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32f10x_bsp_systick_Functions 
 * @brief         
 * @{  
 */
